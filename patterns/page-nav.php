<?php
/**
 * Title: Page nav (back arrow + "Page" label)
 * Slug: microposting/page-nav
 * Inserter: no
 */
?>
...
<div class="wp-block-group single-nav" style="padding-top:6px;padding-right:16px;padding-bottom:6px;padding-left:8px;margin-top:0;margin-bottom:0">
	...
	<p class="single-post-label" style="margin-top:0;margin-bottom:0;font-size:1.1rem;font-weight:700"><?php echo esc_html__( 'Page', 'microposting' ); ?></p>
	<!-- /wp:paragraph -->
